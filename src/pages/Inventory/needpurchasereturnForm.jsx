...
//         const productId = item._id?.product || item.product?.product?._id
//         const isSelected = selectedItemsMap[productId]

//         return {
//           id: index,
//           product: {
//             code: item.product?.product?.product_code || "N/A",
//             name: item.product?.product?.product_name || "Unknown Product",
//             unit: item.product?.product?.unit?.unit || "Unit",
//           },
//           maxQuantity: item.stock || item.inQuantity || 0,
//           returnQuantity: isSelected ? isSelected.returnQuantity : 0,
//           price: item.lastPurchasePrice || item.avgPurchasePrice || 0,
//           total: isSelected ? isSelected.total : 0,
//           selected: isSelected ? true : false,
//           productId: productId,
//           tax: item.product?.product?.product_tax || 0,
//           discount: item.product?.product?.discount || 0,
//           shipping: item.product?.product?.shipping || 0,
//           purchaseId: item._id,
//           purchaseReferenceNo: item.referenceType || "N/A",
//           supplierName: item.product?.product?.suppliers || "Unknown",
//           warehouseName: item.warehouse?.name || "N/A",
//           warehouseCode: item.warehouse?.code || "N/A",
//           batchNumber: item.product?.product?.batchNumber || "N/A",
//           brand: item.product?.product?.brand?.brand || "N/A",
//           category: item.product?.product?.category?.main_category || "N/A",
//         }
//       })
...
//       setValue("returnDate", singlePurchaseReturn.data.returnDate || new Date().toISOString().split("T")[0])
...
//       if (singlePurchaseReturn.data.items && singlePurchaseReturn.data.items.length > 0) {
...
//               total: Math.min(Math.max(0, quantity), item.maxQuantity) * item.price,
//             }
//           : item,
//       ),
//     )
...
//     return returnItems.reduce((sum, item) => (item.selected ? sum + item.total : sum), 0)
//   }
...
//         const totalReturnAmount = selectedItems.reduce((sum, item) => sum + item.total, 0)
...
//           totalReturnAmount,
//           status: "pending",
//           // Use the first selected item's warehouse info
//           warehouseId: selectedItems[0]?.warehouse?._id,
//           warehouseName: selectedItems[0]?.warehouseName,
//           warehouseCode: selectedItems[0]?.warehouseCode,
//         }
...
//           No stock data found.
//           <Button color="inherit" size="small" onClick={() => navigate("/dashboard/purchase")} sx={{ ml: 2 }}>
//             Go to Purchase List
//           </Button>
//         </Alert>
//       </Box>
...
//           Purchase Return
//         </Typography>
//         <Button variant="outlined" startIcon={<ArrowBackIcon />} onClick={handleCancel} sx={{ borderRadius: "8px" }}>
//           Go Back
//         </Button>
//       </Box>
...
//                 Select the items you want to return and specify the quantity. You can select items from multiple
//                 purchases.
//               </Alert>
...
//                         <TableCell sx={{ fontWeight: "bold" }}>Purchase Ref</TableCell>
...
//                           key={item.id}
//                           sx={{
//                             backgroundColor: item.selected ? alpha(theme.palette.primary.main, 0.04) : "inherit",
//                             "&:hover": {
...
//                           </TableCell>
//                           <TableCell>
//                             <Typography variant="body2">#{item.purchaseReferenceNo || "N/A"}</Typography>
//                           </TableCell>
//                           <TableCell>
//                             <Typography variant="body2">{item.supplierName}</Typography>
//                           </TableCell>
//                           <TableCell>
//                             <Chip
...
//                       render={({ field }) => (
//                         <FormControl fullWidth sx={{ mb: 2 }} error={!!errors.warehouse} required>
//                           <InputLabel>Warehouse</InputLabel>
//                           <Select {...field} label="Warehouse" sx={{ borderRadius: 2 }}>
...
//                     color="primary"
//                     startIcon={
//                       isSubmitting || isUpdating ? <CircularProgress size={20} color="inherit" /> : <SaveIcon />
//                     }
//                     disabled={
//                       isSubmitting ||
//                       isUpdating ||
//                       returnItems.filter((item) => item.selected && item.returnQuantity > 0).length === 0
//                     }
//                     sx={{
//                       mb: 1,
//                       borderRadius: "8px",
...
//                     }}
//                   >
//                     {isSubmitting || isUpdating ? "Processing..." : "Confirm Return"}
//                   </Button>
//                   <Button
//                     fullWidth
//                     variant="outlined"
