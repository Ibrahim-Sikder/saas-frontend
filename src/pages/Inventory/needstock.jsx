...
//   const { data: stockData, isLoading: productLoading, isFetching, refetch } = useGetAllStocksQuery(queryParams)
//   useEffect(() => {
...
//     return processedProducts.find((product) => product.id === selectedProductId)
...
//     const totalItems = processedProducts.reduce((sum, item) => sum + item.currentStock, 0)
//     const totalPurchaseValue = processedProducts.reduce((sum, item) => sum + item.totalPurchaseValue, 0)
//     const totalSellingValue = processedProducts.reduce((sum, item) => sum + item.totalSellingValue, 0)

//     return {
//       totalItems: totalItems,
//       totalPurchaseValue: totalPurchaseValue,
//       totalSellingValue: totalSellingValue,
//       lowStockItems: processedProducts.filter((item) => item.status === "low-stock").length,
//       outOfStockItems: processedProducts.filter((item) => item.status === "out-of-stock").length,
//     }
//   }, [processedProducts])
...
//         <MuiLink color="inherit" component={Link} to="/" sx={{ display: "flex", alignItems: "center" }}>
//           <DashboardIcon sx={{ mr: 0.5, fontSize: 18 }} />
//           <Typography variant="body2">Dashboard</Typography>
//         </MuiLink>
//         <MuiLink color="inherit" component={Link} to="/inventory" sx={{ display: "flex", alignItems: "center" }}>
...
//           }}
//         >
//           <Tab icon={<Inventory2Icon />} label="Stock Overview" iconPosition="start" sx={{ fontWeight: "medium" }} />
//           <Tab icon={<TrendingUpIcon />} label="Stock In" iconPosition="start" sx={{ fontWeight: "medium" }} />
//           <Tab icon={<TrendingDownIcon />} label="Stock Out" iconPosition="start" sx={{ fontWeight: "medium" }} />
//           <Tab icon={<BarChartIcon />} label="Analytics" iconPosition="start" sx={{ fontWeight: "medium" }} />
...
//                 {isLoading ? <LinearProgress sx={{ my: 2 }} /> : summaryStats.totalItems.toLocaleString()}
//               </Typography>
...
//               </Box>
//               <Typography variant="h3" sx={{ fontWeight: "bold", mb: 1 }}>
//                 {isLoading ? <LinearProgress sx={{ my: 2 }} /> : formatCurrency(summaryStats.totalPurchaseValue)}
//               </Typography>
//               <Typography variant="body2" color="text.secondary">
...
//               </Box>
//               <Typography variant="h3" sx={{ fontWeight: "bold", mb: 1 }}>
//                 {isLoading ? <LinearProgress sx={{ my: 2 }} /> : summaryStats.lowStockItems}
//               </Typography>
//               <Typography variant="body2" color="text.secondary">
...
//               </Box>
//               <Typography variant="h3" sx={{ fontWeight: "bold", mb: 1 }}>
//                 {isLoading ? <LinearProgress sx={{ my: 2 }} /> : summaryStats.outOfStockItems}
//               </Typography>
//               <Typography variant="body2" color="text.secondary">
//                 Items out of stock
//               </Typography>
...
//                       <TableCell sx={{ fontWeight: "bold" }}>AVG P.P.</TableCell>
...
//                         <TableCell>{formatCurrency(item.avgPurchasePrice)}</TableCell>
...
//                                 height: 4,
//                                 borderRadius: 2,
//                                 backgroundColor: getStockLevelColor(item.currentStock, item.minimumStock),
//                                 opacity: 0.3,
//                               }}
//                             />
//                           </Box>
...
//         <StockDetailsDialog open={openStockDetails} onClose={handleCloseDialogs} product={selectedProduct} />
//       )}
//       {openStockHistory && selectedProduct && (
//         <StockHistoryDialog open={openStockHistory} onClose={handleCloseDialogs} product={selectedProduct} />
//       )}
