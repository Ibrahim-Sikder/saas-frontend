...
//     newItems[index].quantity = floatValue;
//     newItems[index].total = floatValue * newItems[index].rate;
//     newItems[index].total = Number.parseFloat(newItems[index].total.toFixed(2));
...
//     // Allow float values instead of rounding
//     const floatValue = parseFloat(value) || 0;
...
//     const newItems = [...items];
//     newItems[index].rawRate = numericValue;

//     const parsed = parseFloat(numericValue);
//     if (!isNaN(parsed)) {
//       newItems[index].rate = parsed;
//       newItems[index].total = parseFloat(
//         (newItems[index].quantity * parsed).toFixed(2)
//       );
//     }
...
//     newItems[index].rawRate = rate ? formatNumber(rate) : "";
//     setItems(newItems);
//   };
...
//   const handleServiceRateBlur = (index) => {
//     const newItems = [...serviceItems];
//     const rate = newItems[index].rate;
...
//   // Add this useEffect to calculate totals after rate changes
//   useEffect(() => {
//     const updatedItems = [...serviceItems].map((item) => {
//       const rateValue = parseFloat(item.rate) || 0;
//       return {
//         ...item,
//         total: (item.quantity * rateValue).toFixed(2),
//       };
//     });
//     setServiceItems(updatedItems);
//   }, [serviceItems.map((item) => item.rate)]);
...
//                         }
//                         onBlur={(e) => handleServiceRateBlur(i)}
...
//                         }
//                         onBlur={(e) => handleServiceRateBlur(i)}
//                         value={formatNumber(serviceItems[i]?.rawRate) ?? ""}
//                       /> */}
