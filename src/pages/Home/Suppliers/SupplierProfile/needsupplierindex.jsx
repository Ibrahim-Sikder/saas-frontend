...
//                     {supplierWithBillPay?.supplier?.full_name || "Loading..."}
//                   </Typography>
//                   <StatusChip
//                     icon={getStatusIcon(supplierWithBillPay?.supplier?.supplier_status || "Pending")}
//                     label={supplierWithBillPay?.supplier?.supplier_status || "Pending"}
//                     size="small"
//                     statuscolor={getStatusColor(supplierWithBillPay?.supplier?.supplier_status || "Pending")}
//                     sx={{ ml: 2 }}
//                   />
...
//                   <span style={{ color: "#757575" }}>{supplierWithBillPay?.supplier?.vendor || "Supplier"}</span>
//                 </Typography>
//                 <Box sx={{ display: "flex", alignItems: "center", mt: 1 }}>
//                   <StyledRating
//                     name="supplier-rating"
//                     value={supplierWithBillPay?.supplier?.supplier_rating || 0}
//                     precision={0.1}
//                     readOnly
...
//                     ({supplierWithBillPay?.supplier?.supplier_rating || 0})
//                   </Typography>
//                 </Box>
//               </Box>
...
//                   </Typography>
//                   <Typography variant="body1" fontWeight="medium">
//                     ${supplierData.creditLimit.toLocaleString()}
//                   </Typography>
//                 </Box>
//                 <Box sx={{ mr: 4 }}>
//                   <Typography variant="body2" color="text.secondary">
...
//                     variant="body1"
//                     fontWeight="medium"
//                     color={supplierData.availableCredit < 5000 ? "error.main" : "inherit"}
//                   >
//                     ${supplierData.availableCredit.toLocaleString()}
//                   </Typography>
//                 </Box>
//                 <Box>
//                   <Typography variant="body2" color="text.secondary">
